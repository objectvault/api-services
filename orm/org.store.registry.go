...
func CountRegisteredOrgStores(db *sql.DB, org uint64, q TQueryConditions) (uint64, error) {
...
func QueryRegisteredStores(db *sql.DB, org uint64, q TQueryConditions, c bool) (TQueryResults, error) {
